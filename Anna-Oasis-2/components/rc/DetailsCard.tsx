    ...
    return (
        <View className="w-full mb-4 min-h-[100px] bg-white rounded-xl shadow p-4 flex-row items-start">
            ...
            <View className="flex-1 flex-col">
                ...
                <View className="mt-2">
                    <Text className="text-base text-gray-700">Register No: {details.registerNo || '-'}</Text>
                    <Text className="text-base text-gray-700">Department: {details.dept || '-'}</Text>
                </View>
            </View>
        </View>
    );
