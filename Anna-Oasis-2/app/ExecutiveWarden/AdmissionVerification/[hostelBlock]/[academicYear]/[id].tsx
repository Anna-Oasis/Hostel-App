...
import { ewAllocateRoom, handleUpdateEWAdmission } from '@/utils/executiveWarden/ewAdmissionApi';
      ...
      <ScrollView className="flex-1 w-full sm:w-[80%] md:w-[50%] self-center">
        ...
        {selectedFloor !== null && roomsByFloor[selectedFloor] && (
          <View className="flex flex-row flex-wrap gap-3">
            {[...roomsByFloor[selectedFloor]].sort((a, b) => a.roomNumber - b.roomNumber).map((room, idx) => {
              const isSelected =
