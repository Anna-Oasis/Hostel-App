...
const ParentDetails = () => (
  <>
    ...
    <Text className="text-base font-semibold mb-2 mt-2">Father's Details</Text>
    ...
    {/* Mother Details */}
    <Text className="text-base font-semibold mb-2 mt-2">Mother's Details</Text>
    <Divider className="mb-3" />
    ...
    <Text className="text-base font-semibold mb-2 mt-2">Residential Address (India)</Text>
    <Divider className="mb-3" />
    ...
    <Text className="text-base font-semibold mb-2 mt-2">Residential Address (Foreign)</Text>
    <Divider className="mb-3" />
