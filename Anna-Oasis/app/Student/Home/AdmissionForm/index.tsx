...
import StudentDetails from "./FormPages/StudentDetails";
import ParentDetails from "./FormPages/ParentDetails";
import LocalGuardian from "./FormPages/LocalGuardian";
import HostelMessDeclaration from "./FormPages/HostelMessDeclaration";
