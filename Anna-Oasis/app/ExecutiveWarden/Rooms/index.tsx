      ...
      {({ handleSubmit }) => (
        <View className="flex-1 bg-white p-4">
          ...
          <ScrollView className="flex-1">
            ...
            {Object.entries(roomDetails).map(([block, floors], blockIdx, arr) => (
              <View key={block} className="mb-8">
                ...
                {Object.entries(floors as Record<string, any[]>).map(([floor, rooms]) => (
                      ...
                      {rooms.map((room, idx) => (
                        ...
                        >
                          ...
                          <Text className="text-xs text-slate-500 text-center">
                            {room.rollNo && Array.isArray(room.rollNo) && room.rollNo.length > 0
                              ? room.rollNo.join(', ')
                              : 'Vacant'}
                          </Text>
                        </View>
